...
class UdpLogic(Tcp_ucpUi):
    ...
    def socket_open_udp(self):
        ...
        try:
            ...
            print('Error:', ret)
            QMessageBox.critical(self, 'Error', 'Hafen ist bereits besetzt')
            # 关闭udp socket
            self.socket_close_u()
        else:
    ...
    def data_send_u(self):
        ...
        try:
            ...
            QMessageBox.critical(self, 'Error', 'Bitte geben Sie die richtige IP- und Portnummer des Remote-Hosts ein')
        else:
            if self.working is False:
                QMessageBox.critical(self, 'Vorbehalt', 'Bitte richten Sie zuerst das UDP-Netzwerk ein')
            else:
                if self.link:
                    ...
                    if get_msg:
                        ...
                        QMessageBox.critical(self, 'Vorbehalt', 'Senden darf nicht leer sein')
                else:
                    QMessageBox.critical(self, 'Vorbehalt', 'Derzeit keine Verbindung')
